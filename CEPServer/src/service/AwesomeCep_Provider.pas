...
type
  TAwesomeCepProvider = class(TInterfacedObject, ICepProvider)
  public
...
const
  URL_CEP = 'https://cep.awesomeapi.com.br/json/%s';

function TAwesomeCepProvider.Consultar(const ACep: string): string;
var
  Http: THTTPClient;
  Resp: IHTTPResponse;
begin
